    ...
    private void initComponents() {
        ...
        JPanel fertilizerPanel = createItemPanel(
            ...
            e -> {
                if (resourceManager.getMoney() >= 20) {
                    ...
                    showMessage("肥料買好了，快去餵食小植物們吧！", new Color(46, 139, 87));
                } else {
                    showMessage("錢錢不夠啦！去賣點作物再來吧～", new Color(178, 34, 34));  // 深紅色
                }
                updateItemCounts();
            }
        );
        ...
        for (CropType crop : CropType.values()) {
            ...
            JPanel seedPanel = createItemPanel(
                ...
                description,
                crop.getSeedCost(),
                resourceManager.getResourceAmount(crop.getDisplayName() + "_seeds"),
                e -> {
                    if (resourceManager.getMoney() >= crop.getSeedCost()) {
                        ...
                        showMessage("錢錢不夠買" + crop.getDisplayName() + "種子啦！", new Color(178, 34, 34));  // 深紅色
                    }
                    updateItemCounts();
                }
            );
