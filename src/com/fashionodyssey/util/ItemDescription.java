...
public enum ItemDescription {
    ...
    public String getAcquiredDescription() {
        return switch (this) {
            ...
            case RED_FABRIC -> "獲取方法：於加工場合成取得，1個白色布料+1個紅色染料=1個紅色布料";
            case YELLOW_FABRIC -> "獲取方法：於加工場合成取得，1個白色布料+1個黃色染料=1個黃色布料";
            case PINK_FABRIC -> "獲取方法：於加工場合成取得，1個白色布料+1個粉色染料=1個粉色布料";
            case PURPLE_FABRIC -> "獲取方法：於加工場合成取得，1個白色布料+1個紫色染料=1個紫色布料";
            ...
            case PINK_LACE -> "獲取方法：於加工場合成取得，1個白色蕾絲+1個粉色染料=1個粉色蕾絲";
            case PURPLE_LACE -> "獲取方法：於加工場合成取得，1個白色蕾絲+1個紫色染料=1個紫色蕾絲";
